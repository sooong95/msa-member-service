package member.member.config;

import jakarta.servlet.http.HttpServletRequest;
import lombok.RequiredArgsConstructor;
import member.member.jwt.JwtFilter;
import member.member.jwt.JwtUtils;
import member.member.jwt.LoginFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                .requestMatchers("/login", "/", "/join", "/join/shop","/shopSearch", "/member/home").permitAll() // 해당 경로는 모든 권한 허용
